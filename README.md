# Тесты приложения Wikipedia на эмуляторе Android устройства 
# и ферме мобильных устройств [browserstack.com](https://(https://www.browserstack.com/) в качестве дипломной работы для qa.guru
## Содержание
